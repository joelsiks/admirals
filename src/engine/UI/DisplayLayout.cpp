...
float admirals::UI::DisplayLayout::GetHeightFromDisplayPosition(DisplayPosition pos, const vec2& displaySize) {
    float height = 0;
...
void admirals::UI::DisplayLayout::RenderUIElements() {
    for (const auto& element : m_elements) {
        ...
        element->Render(this->m_font, vec2{m_positionOffsets[pos], startHeight});
